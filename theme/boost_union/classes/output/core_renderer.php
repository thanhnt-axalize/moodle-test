...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function full_header() {
        ...
        if (
            ...
            (get_config('theme_boost_union', 'courseheaderimageenabled') == THEME_BOOST_UNION_SETTING_SELECT_YES)
        ) {
    ...
    public function render_login(\core_auth\output\login $form) {
        ...
        // Check if the logo alt text is set.
        $logoalttextsetting = get_config('theme_boost_union', 'logoalttext');
        $context->logoalttext = !empty($logoalttextsetting) ? $logoalttextsetting : $context->sitename;
