...
$string['navbarheightheading'] = 'Navbar height';
// ... ... Setting: Navbar max height.
$string['navbarheightsetting'] = 'Navbar max height';
$string['navbarheightsetting_desc'] = 'With this setting, you can override Moodle\'s navbar height without manual SCSS modifications. By default, Moodle uses a navbar height of 60px. You can enter other pixel-based values like 100px, but values with other units like percentage-based values or a viewport-height value won\'t work.';
...
// ... ... Setting: Logo alt text.
$string['logoalttextsetting'] = 'Logo alt text';
$string['logoalttextsetting_desc'] = 'With this setting, you can set the alt text for the logo. This text will be used as the alt attribute of the logo image. It is important for accessibility reasons and for search engine optimization.';
...
// ... ... Setting: Compact logo alt text.
$string['logocompactalttextsetting'] = 'Compact logo alt text';
$string['logocompactalttextsetting_desc'] = 'With this setting, you can set the alt text for the compact logo. This text will be used as the alt attribute of the logo image. It is important for accessibility resons and for search engine optimization.';
// ... Section: Favicon.
