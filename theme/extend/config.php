...
/**
 * The configuration for Extend theme is defined here.
 *
...
$THEME->scss = function($theme) {
    return theme_extend_get_main_scss_content($theme);
};
