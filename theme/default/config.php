...
/**
 * The configuration for Default theme is defined here.
 *
...
$THEME->scss = function ($theme) {
    return theme_default_get_main_scss_content($theme);
};
